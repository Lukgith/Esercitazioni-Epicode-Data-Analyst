...
def translate_to_1000(n):
    ...
    CENTAIA = ["cento", "duecento", "trecento", "quattrocento", "cinquecento",
               "seicento", "settecento", "ottocento", "novecento"]
    centinaio =  n // 100 # la centinaia da n
    decade = (n - (centinaio *100)) # la decina da n
    #unit = n % 10 # l'unit� di n
    return CENTAIA[centinaio-1] + translate_to_100(decade)
