...
-- SELECT YEAR(DATA_ASSUNZIONE) AS ANNI
-- FROM DIPENDENTE 
...
-- SELECT NOME_DIPARTIMENTO AS DIPARTIMENTO, ID_MANAGER AS MANAGER, SALARIO, DATA_ASSUNZIONE AS DAT
-- FROM DIPENDENTE D
...
-- SELECT NOME 
-- FROM DIPENDENTE
-- WHERE  = ( SELECT DATEDIFF(MAX('DATA_ASSUNZIONE'),('DATA_ASSUNZIONE')) > (5*365))
